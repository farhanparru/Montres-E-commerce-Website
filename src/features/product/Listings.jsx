...
import { FaShippingFast, FaShieldAlt, FaStar, FaGift, FaArrowRight } from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <Helmet>
        ...
        <meta name="description" content="Browse our premium luxury categories including watches, jewelry, bags, and home decor. The finest collections in UAE." />
        <meta name="keywords" content="luxury categories UAE, Dubai premium shopping, luxury watches, designer bags Dubai" />
      </Helmet>

      {/* Hero Banner */}
      <div className="bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto px-4 py-20 text-center">
          <h1 className="text-4xl md:text-5xl font-serif mb-4">Discover Luxury Collections</h1>
          <p className="text-xl md:text-2xl mb-8">Curated premium categories for the discerning shopper</p>
          <button className="bg-amber-500 hover:bg-amber-600 text-white font-medium py-3 px-8 rounded-md transition-colors">
            Shop Now
          </button>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-serif text-gray-900 mb-2">Our Premium Categories</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">Explore our carefully selected luxury categories featuring the finest products from around the world</p>
        </div>
            ...
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-shadow duration-300">
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute bottom-0 left-0 p-6 text-white">
                  <h3 className="text-2xl font-medium mb-1">{category.title}</h3>
                  <p className="text-sm opacity-90 mb-3">{category.description}</p>
                  <div className="flex items-center justify-between">
                    <span className="text-sm bg-black/30 px-2 py-1 rounded">{category.items} items</span>
      ...
      <div className="bg-gray-50 py-12">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Handpicked luxury items from our collections</p>
          </div>
      ...
      <section className="bg-white py-12 border-t">
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
          {[
            { 
              icon: <FaShippingFast className="text-amber-500 text-4xl mx-auto mb-4" />, 
              title: "Fast Delivery", 
              description: "Free shipping across UAE on orders over 500 AED" 
            },
            { 
              icon: <FaShieldAlt className="text-amber-500 text-4xl mx-auto mb-4" />, 
              title: "Authenticity Guaranteed", 
              description: "All products come with certification" 
            },
            { 
              icon: <FaStar className="text-amber-500 text-4xl mx-auto mb-4" />, 
              title: "Premium Quality", 
              description: "Curated selection of luxury items" 
            },
            { 
              icon: <FaGift className="text-amber-500 text-4xl mx-auto mb-4" />, 
              title: "Gift Services", 
